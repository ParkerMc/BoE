"""
From https://github.com/dpallot/simple-websocket-server/blob/master/SimpleWebSocketServer/SimpleWebSocketServer.py
The MIT License (MIT)
...
class SimpleWebSocketServer(object):
    ...
    def _constructWebSocket(self, sock, address):
        return self.websocketclass(self, sock, address, self.mods)
    ...
    def closeClient(self, client, ready):
        client.client.close()
        client.handleClose()
...
class SSLWebSocketServer(SimpleWebSocketServer):
    def __init__(self, host, port, websocketclass, certfile, keyfile, version=ssl.PROTOCOL_TLSv1, selectInterval=0.1):
